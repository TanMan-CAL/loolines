...
function PeopleChip({ count }: { count: number }) {
  ...
  return (
    <div
      className={`px-2 py-1 border gap-2 flex rounded-lg items-center justify-center text-2xl w-[150px] ${
...
function TimeChip( { count }: { count: number } ) {
  return (
    <div
      className={`px-2 py-1 border gap-2 flex rounded-lg items-center w-[150px] bg-[#e1e3e6] text-[#717882]`}
    >
      <Timer />
